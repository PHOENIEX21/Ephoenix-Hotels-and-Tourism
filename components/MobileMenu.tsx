...
export default function MobileMenu() {
  ...
  return <>
    ...
    <button type="button" ref={toggleRef} className="menu-toggle" onClick={() => setOpen(current => !current)} aria-label={open ? 'Close navigation' : 'Open navigation'} aria-expanded={open}>
      <span /><span /><span />
    </button>
    <div ref={menuRef} className={open ? 'mobile-menu is-open' : 'mobile-menu'}>

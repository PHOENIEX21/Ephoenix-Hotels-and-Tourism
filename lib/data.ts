...
export const rooms: RoomType[] = [
  room('main', 'Diamond Suite', 60000, 20000, ['109', '110', '111', '112'], cloudinary('ephoenix/main/diamond-suite/photo-01')),
  room('main', 'Legacy Room', 40000, 15000, ['141', '142', '143', '144', '145', '146', '147'], cloudinary('ephoenix/main/legacy-room/photo-01')),
  room('main', 'Wole Olanipekun', 35000, 15000, ['106', '107', '108', '148', '149', '150', '151', '152', '153', '154', '155', '156'], cloudinary('ephoenix/main/wole-olanipekun/photo-01')),
  room('main', 'Platinum Luxury', 40000, 15000, ['101', '102', '104', '105'], cloudinary('ephoenix/main/platinum-luxury/photo-01')),
  room('main', 'Pentagon', 30000, 15000, ['132', '133', '134', '135', '136', '137', '138', '139'], cloudinary('ephoenix/main/pentagon/photo-01')),
  room('main', 'Classic Room', 25000, 10000, ['103', '113', '114', '115', '116', '118', '119', '121', '122', '124', '125', '126', '127', '128', '129', '140'], cloudinary('ephoenix/main/classic-room/photo-01')),
  room('main', 'Standard Double', 22000, 10000, ['117', '120', '123'], cloudinary('ephoenix/main/standard-double/photo-01')),
  room('annex-i', 'Luxury Rooms', 40000, 15000, ['301', '302', '303', '304', '305', '306', '307', '308', '309', '310', '313', '315', '316', '317', '318', '319', '321', '322', '323', '327'], cloudinary('ephoenix/annex-i/luxury-rooms/photo-01')),
  room('annex-i', 'Superior Luxury', 45000, 20000, ['311', '312', '314', '320', '324', '325', '326'], cloudinary('ephoenix/annex-i/superior-luxury/photo-01')),
  room('annex-i', "Director's Suite", 65000, 25000, ['328'], cloudinary('ephoenix/annex-i/directors-suite/photo-01')),
  room('annex-i', "Chairman's Suite", 70000, 30000, ['329'], cloudinary('ephoenix/annex-i/chairmans-suite/photo-01')),
  room('annex-ii', 'Standard', 35000, 15000, ['509', '529', '549']),
  room('annex-ii', 'Classic', 45000, 20000, ['501', '502', '503', '504', '505', '507', '516', '521', '522', '523', '524', '527', '530', '531', '532', '533', '536', '543', '544', '545', '550', '551', '552', '553', '554', '555', '557', '558', '559', '560'], cloudinary('ephoenix/annex-ii/classic/photo-01')),
  room('annex-ii', 'Deluxe', 50000, 20000, ['508', '510', '511', '512', '513', '514', '515', '519', '528', '534', '535', '538', '539', '540', '541', '546'], cloudinary('ephoenix/annex-ii/deluxe/photo-01')),
  room('annex-ii', 'Super Deluxe', 60000, 25000, ['506', '517', '518', '525'], cloudinary('ephoenix/annex-ii/super-deluxe/photo-01')),
  room('annex-ii', 'City View Luxury', 65000, 25000, ['526', '547'], cloudinary('ephoenix/annex-ii/city-view-luxury/photo-01')),
  room('annex-ii', 'Pool View Suite', 85000, 35000, ['520', '537', '542', '556'], cloudinary('ephoenix/annex-ii/pool-view-suite/photo-01')),
  room('annex-ii', 'White House City View', 105000, 50000, ['561'], cloudinary('ephoenix/annex-ii/white-house-city-view/photo-01')),
  room('annex-ii', 'Senatorial Suite', 155000, 75000, ['562'], cloudinary('ephoenix/annex-ii/senatorial-suite/photo-01')),
